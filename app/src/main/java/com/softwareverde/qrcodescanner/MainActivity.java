 ...
 */
public class MainActivity extends CaptureActivity implements SurfaceHolder.Callback {
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (rawResult != null) {
            ...
            final Intent intent = new Intent(this.getApplicationContext(), ScanResultActivity.class);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setPositiveButton(R.string.okay_button_text, new DialogInterface.OnClickListener() {
            @Override
    ...
    public void onRequestPermissionsResult(final int requestCode, @NonNull final String[] permissions, @NonNull final int[] grantResults) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                this.startActivity(new Intent(MainActivity.this.getApplicationContext(), MainActivity.class));
                this.finish();
            }
            else {
